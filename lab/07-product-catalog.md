...
Fix the bug where the Kafka message published on product creation drops the upc field. Find it, fix it, and prove the fix by running the integration test suite. Iterate until the tests pass.
```
